...
u32 SSD_decode(u8 key_value, u8 cathode){
	...
	case 66: if(cathode==0) return 0b01111111; else return 0b11111111;
	case 67: if(cathode==0) return 0b00111001; else return 0b10111001;
	case 68: if(cathode==0) return 0b00111111; else return 0b10111111;
...
static void prvTxTask( void *pvParameters )
{
	for( ;; ) {
	   ...
	   while (1) {
		  ...
		  ssd_value = SSD_decode(previous_key, 1);		//this function will decode the ASCII value obtained from keypad into the corresponding HEX value for display on SSD
